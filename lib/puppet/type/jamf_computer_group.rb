...
Puppet::Type.newtype(:jamf_computer_group) do
  desc 'Manages Computer Groups within a Jamf Pro Server'

  ensurable

  # namevar is always a parameter
  newparam(:name, namevar: true) do
    desc 'Name of the Computer Group'
  ...
  newproperty(:is_smart, boolean: true, parent: Puppet::Property::Boolean) do
    desc 'Whether this computer group is smart or static.'
  ...
  newparam(:api_url) do
    desc 'URL of the JAMF API. Note: we will append "/JSSResource/computergroups" to the end of this. Default: https://127.0.0.1:8443'
  ...
  newparam(:group_name) do
    desc 'Name of the computer group for cloud servers.'
