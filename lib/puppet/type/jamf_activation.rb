Puppet::Type.newtype(:jamf_activation) do
  desc "Manages a JAMF server's activation using an activation code."

  ensurable

  # namevar is always a parameter
  newparam(:name, namevar: true) do
    desc 'Name of the organization the activation code belongs to.'
  ...
  newproperty(:activation_code) do
  ...
  newparam(:api_url) do
    desc 'URL of the JAMF API. Note: we will append "/JSSResource/activationcode" to the end of this. Default: https://127.0.0.1:8443'
